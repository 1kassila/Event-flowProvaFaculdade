...
import { View, Text, ScrollView, TextInput, StyleSheet, Pressable, ImageBackground, Alert } from "react-native";


export default function Perfil() {

    const handlePress = () => {
        Alert.alert("Atenção", "Deseja realmente excluir o evento?");
    };
    ...
    return (
        <ScrollView style={styles.rola}>
            ...
            <View style={styles.titleH1}>
                <Text style={styles.h2}>Listagem de Eventos</Text>
            </View>
            ...
            <View style={styles.contEvent}>
                <Link href="/cadastrar" asChild>
                    <Pressable style={styles.event}>
                        <Text style={styles.btn}>Criar Evento +</Text>
                    </Pressable>
                </Link>
            </View>
                ...
                >
                    <View style={styles.contExclui}>
                        <Pressable onPress={handlePress} style={styles.exclui}>
                            <Text style={styles.h3}>Excluir Evento</Text>
